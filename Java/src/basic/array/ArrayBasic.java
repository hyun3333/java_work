...
public class ArrayBasic {
		public static void main(String[] args) {
			 ...
			 *  인덱스란 배열 내부의 위치를 지정할 수 있는 값입니다.  *
			 ...
			 6. 배열의 반복문 처리
			    배열은 인덱스 번호를 제어변수로 활용하여 쉽게 반복문 처리를 할 수 있습니다.
			    
			    for 배열의 길이
			 for(int idx=0; idx<arr.length; idx++) 
			
 			 7. Arrays.toString(arr)은 배열의 내부의 요소값을 문자열 형태로 한눈에 출력한다.
...
//			arr[3] = 3.14; 
			// 같은 타입끼리만 선언 할 수 있다 arr은 현재 int로 선언
			arr[3] =(int) 3.14; 
			
//			arr[4] = "들어갈까요?"; 
			// string은 변환을해도 int로 변환이 되지 않아 들어가지 않는다
			arr[4] = 100;
...
//			9-1. 선언과 동시에 초기화를 할 때 
//				 딱 한번만 가능한 문법
			String[] names = {"홍길동", "김철수", "박영희"};
			
//			9-2. 배열은 크기가 고정이기 때문에 늘어나거나 줄어들 수 없습니다.
//				 만약 배열의 크기를 늘리거나 줄이고 싶다면
//			     기존의 배열을 조작하는것이 아니라 새롭게 생성하셔야 합니다.
